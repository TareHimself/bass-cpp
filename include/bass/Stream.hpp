...
namespace bass
{
    ...
    FileStream* createFileStream(const std::filesystem::path& file, DWORD offset = 0,
                                  DWORD flags = CreateSampleFloat);
    ...
    UrlStream* createUrlStream(const std::string& url, DWORD offset = 0,
                                 DWORD flags = CreateSampleFloat);
